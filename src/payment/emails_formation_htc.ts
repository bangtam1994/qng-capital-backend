export const emailFormationHTC = (userName: string) => `<!doctype html>
<html lang="fr">
<head>
  <meta charset="UTF-8">
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="offer">
        ...
        <p>Tu as souscrit à notre formule de formation HTC, qui inclut :</p>
        <ul>
          <li>Accès aux modules vidéos (tous niveaux)</li>
          <li> Accès E-books et supports</li>
          <li>Études de cas pratiques sur des trades réussis et ratés</li>
          <li>Checklist quotidienne de prépa trading</li>
      ...
      <p>Voici où tu trouveras toutes les informations nécessaires sur la formation, ainsi qu'un accès direct à moi-même pour échanger. Tu pourras aussi découvrir les autres membres et rester informé des dernières actualités.</p>
      
      
      <div style="display:flex; justify-content: center"><a href="https://discord.gg/WpKFrNbYC3" class="button">Rejoindre le Discord HTC</a></div>
                      ...
                      <tr style="width:100%">
                        ...
                        >
                          <div style="padding:0px 0px 0px 0px">
                            ...
                            >
                              Formation Honma - Prélèvement mensuel
                            </div>
                          </div>
                        </td>
                        <td
